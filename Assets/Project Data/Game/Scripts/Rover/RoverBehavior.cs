    ...
    public class RoverBehavior : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            if (IsRunning)
            {
                ...
                CameraController.SetOffset(Mathf.InverseLerp(0, 200, Rigidbody.velocity.sqrMagnitude) * 0.1f + 1);
        ...
        public void Finish(Transform finishPoint)
        {
            ...
            transform.DOMove(finishPoint.position, 0.5f, false, TweenType.FixedUpdate).SetEasing(Ease.Type.SineOut);
            transform.DORotate(Quaternion.identity, 0.5f, false, TweenType.FixedUpdate).SetEasing(Ease.Type.SineOut);
